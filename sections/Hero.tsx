...
const Hero = () => {
  return (
    <section className="teambg">
        <div>
            <div className='font-bold text-8xl text-center gradienttext mt-6 italic'>
                OZANGELES FC
            </div>
