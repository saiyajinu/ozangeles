...
const MatchResult = (props: IMatchResultProps) => {
  return (
        <div className="flex border-b-2 mt-4 border-black mx-auto py-2 px-2 max-w-4xl">
            ...
            {
                props.isCup ? <img src="/assets/images/supercupa.png" className="w-[35px] my-auto mx-auto" /> : <img src="/assets/images/liga3f.png" className="w-[35px] my-auto mx-auto " />  
            }
            </div>
        ...
        <div className="my-auto basis-[5%] text-center">{props.score}</div>
        ...
        <div className="my-auto basis-[10%] text-center">{props.date}</div>
      </div>
